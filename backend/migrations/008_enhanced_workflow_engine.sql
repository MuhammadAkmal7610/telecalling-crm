...
-- 4. Email queue for automated emails
...
-- 6. Webhook queue for external API calls
...
CREATE INDEX IF NOT EXISTS idx_workflow_executions_ws ON workflow_executions(workspace_id);
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tablename = 'workflow_executions' AND policyname = 'Users can view workflow executions in their workspace'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'workflow_executions' AND policyname = 'Users can insert workflow executions in their workspace'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'email_queue' AND policyname = 'Users can view email queue in their workspace'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'email_queue' AND policyname = 'Users can insert email queue in their workspace'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'sms_queue' AND policyname = 'Users can view SMS queue in their workspace'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'sms_queue' AND policyname = 'Users can insert SMS queue in their workspace'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'webhook_queue' AND policyname = 'Users can view webhook queue in their workspace'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'webhook_queue' AND policyname = 'Users can insert webhook queue in their workspace'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'email_templates' AND policyname = 'Users can view email templates in their workspace'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'email_templates' AND policyname = 'Users can insert email templates in their workspace'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'sms_templates' AND policyname = 'Users can view SMS templates in their workspace'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'sms_templates' AND policyname = 'Users can insert SMS templates in their workspace'
    ) THEN
