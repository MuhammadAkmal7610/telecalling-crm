...
export default function UsersManagement() {
    ...
    const inviteUser = async (formData) => {
        try {
            ...
            modal.success({
                title: 'User Invited',
                message: `An invitation email has been sent to ${formData.email}.`,
                confirmText: 'Done'
            });
            fetchUsers();
        } catch (e) {
    ...
    const handleUserStatusChange = async (userId, newStatus) => {
        ...
        const isConfirmed = await modal.confirm({
            ...
            message: `Are you sure you want to ${action} this user? This will affect their ability to access the platform.`,
            confirmText: newStatus === 'Suspended' ? 'Suspend' : 'Activate',
            type: newStatus === 'Suspended' ? 'warning' : 'confirm'
        });
        ...
        try {
            ...
            if (res.ok) {
                modal.success({
                    ...
                    message: `User has been successfully ${newStatus.toLowerCase()}.`
                });
                fetchUsers();
            } else {
                const err = await res.json();
