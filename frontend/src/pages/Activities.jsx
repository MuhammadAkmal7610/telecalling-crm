        ...
        try {
            ...
            const grouped = data.reduce((acc, curr) => {
                ...
                const item = {
                    id: curr.id,
                    type: curr.type || 'note',
                    title: curr.type === 'call' ? 'Call Log' : 'Update',
                    subtitle: curr.lead?.name || 'Lead update',
                    description: curr.details?.note || curr.details?.remark || 'No details',
                    time: new Date(curr.created_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
                    user: curr.user?.name || 'Admin',
                    duration: curr.details?.duration,
                    badgeColor: getBadgeColor(curr.type)
                };
