...
const DragHandle = () => (
    <svg className="w-5 h-5 text-gray-300 cursor-move hover:text-gray-400" viewBox="0 0 20 20" fill="currentColor">
        <path d="M7 2a1 1 0 11-2 0 1 1 0 012 0 zm0 5a1 1 0 11-2 0 1 1 0 012 0zM7 12a1 1 0 11-2 0 1 1 0 012 0zm0 5a1 1 0 11-2 0 1 1 0 012 0zm6-15a1 1 0 11-2 0 1 1 0 012 0zm0 5a1 1 0 11-2 0 1 1 0 012 0zM13 12a1 1 0 11-2 0 1 1 0 012 0zm0 5a1 1 0 11-2 0 1 1 0 012 0z" />
    </svg>
);
