...
const RoleTag = ({ role }) => {
    ...
    const icons = { root: KeyIcon, admin: Cog6ToothIcon, manager: UserIcon, marketing: MegaphoneIcon, caller: PhoneIcon };
...
export default function AdminDashboard() {
    ...
    const { isAdmin, isRoot, can } = usePermission();
    ...
    // Redirect non-admins
    useEffect(() => {
        if (!isAdmin && !isRoot) navigate('/dashboard');
    }, [isAdmin, isRoot]);
