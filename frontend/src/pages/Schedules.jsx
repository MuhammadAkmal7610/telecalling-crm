...
export default function Schedules() {
    ...
    const confirmDelete = async () => {
        ...
        finally { setDeletingId(null); setItemToDelete(null); }
    };
    ...
    return (
        <WorkspaceGuard>
            <div className="flex-1 overflow-y-auto px-6 py-8 md:p-8 bg-gray-50/50">
            ...
            <ConfirmModal
                ...
                message="Are you sure you want to delete this follow-up schedule? This action cannot be undone."
                confirmText="Delete"
                cancelText="Cancel"
            />
