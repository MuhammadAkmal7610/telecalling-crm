...
export default function Campaigns() {
    ...
    const handleDelete = async (id) => {
        const isConfirmed = await modal.confirm({
            ...
            message: 'Are you sure you want to delete this campaign? This action cannot be undone and all associated data will be removed.',
            confirmText: 'Delete',
            type: 'danger'
        });
        ...
        try {
            ...
            if (res.ok) {
                modal.success({
                    ...
                    message: 'The campaign has been successfully removed.'
                });
                fetchCampaigns();
            } else {
                modal.error({
                    title: 'Deletion Failed',
                    message: 'Could not delete the campaign. Please try again.'
                });
            }
        } catch (error) {
            modal.error({
            ...
            <CampaignModal
                ...
                onSuccess={() => {
                    ...
                    modal.success({
                        ...
                        message: 'Your new campaign is ready to go!',
                        confirmText: 'Awesome'
                    });
                }}
            />
